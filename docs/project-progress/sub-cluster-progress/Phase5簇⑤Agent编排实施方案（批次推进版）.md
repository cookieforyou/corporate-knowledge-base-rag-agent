...
> **版本**：v1.8（E2E 验收收官：演示 10 例 10/10 通过）· **日期**：2026-09-06 · **工时**：3d · **模块跨度**：kb-ai-agent / kb-api / kb-ai-core（指标）/ frontend / docs
