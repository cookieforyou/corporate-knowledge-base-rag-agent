...
> **版本**：v1.9（收官注记① 改进落地：主 Agent 任务边界纪律）· **日期**：2026-09-06 · **工时**：3d · **模块跨度**：kb-ai-agent / kb-api / kb-ai-core（指标）/ frontend / docs
