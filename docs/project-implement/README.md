...
| 第六章 | [Maven 多模块工程结构](./06-Maven多模块工程结构.md) | v1 原文 + v2.9（3.19：新增 kb-ai-agent 模块与依赖链，9 模块）+ v2.10（新增 §6.3 全局常量收敛规约——Constants 五分区 [ErrorCodes/Retrieval/ChatMode/SseEvent/AuditStatus] + 收敛边界六条） |
