...
public class RagChatService {
    ...
    public RagChatService(@Qualifier(Constants.BeanNames.RAG_AGENT_CHAT_CLIENT) ChatClient chatClient) {
    ...
    public String chatRag(String query, String sessionId, RetrievalContext retrievalContext) {
        return chatClient.prompt()
            ...
            .advisors(spec -> spec
                ...
                .param(AuditTraceAdvisor.MODE_KEY, Constants.ChatMode.MODE_RAG))
            .call()
            .content();
    }
